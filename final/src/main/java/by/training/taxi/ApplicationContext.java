...
import by.training.taxi.car.CarListView;
...
public class ApplicationContext implements BeanRegistry {
    ...
    private void registerClasses() {
        ...
        registerBean(DeclineRequestCommand.class);
        ...
        registerBean(CarListWithRequirementCommand.class);
        registerBean(FillWalletCommand.class);
        registerBean(IncomingRequestsViewCommand.class);
        ...
        registerBean(PostRequestInfoCommand.class);
