...
public class EditContactCommand implements Command {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws CommandException {
        try {
            ...
            ValidationResult clientResult = userDataValidator.validate(request);
    ...
    private DriverDto buildDriver(HttpServletRequest request, HttpServletResponse response, UserAccountDto user, ContactDto contact) {
        DriverDataValidator driverDataValidator = new DriverDataValidator();
        ValidationResult driverResult = driverDataValidator.validate(request);
