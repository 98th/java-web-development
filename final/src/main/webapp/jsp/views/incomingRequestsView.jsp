        ...
        <c:choose>
            <c:when test="${not empty incomingRequests}">
                <table class="mdl-data-table mdl-js-data-table">
                    ...
                    <tbody>
                    <c:forEach items="${incomingRequests}" var="r">
                        <tr>
                            ...
                            <td class="mdl-data-table__cell--non-numeric">
                                <form action="${pageContext.request.contextPath}/" method="POST">
                                    ...
                                    <input type="hidden" name="commandName" value="confirmRequest"/>
                            ...
                            <td class="mdl-data-table__cell--non-numeric">
                                <form action="${pageContext.request.contextPath}/" method="POST">
                                    <input type="hidden" name="requestId" value="${r.id}"/>
                                    <input type="hidden" name="commandName" value="declineRequest"/>
                                    <input class="mdl-button mdl-js-button" type="submit" value="<fmt:message key="label.decline"/>"/>
                                </form>
                            </td>
                        </tr>
                    </c:forEach>
